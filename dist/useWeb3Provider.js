    ...
    useEffect(() => {
        ...
        const setupEventListeners = () => {
            ...
            if (window.ethereum?.on) {
                ...
                const removeChain = () => window.ethereum?.removeListener?.('chainChanged', handleEthereumEvent);
                const removeAccounts = () => window.ethereum?.removeListener?.('accountsChanged', handleEthereumEvent);
